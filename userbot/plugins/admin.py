...
from userbot.utils import sycrox_cmd, errors_handler, register
...
@borg.on(sycrox_cmd(pattern=r"setgpic"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"promote(?: |$)(.*)"))
@errors_handler
async def promote(promt):
    ...
    if not rank:
        rank = "Devil ka Beta"  # Just in case.
    if user:
        pass
    else:
        return
...
@borg.on(sycrox_cmd(pattern=r"demote(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"ban(?: |$)(.*)"))
@errors_handler
async def ban(bon):
...
@borg.on(sycrox_cmd(pattern=r"unban(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"mute(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"unmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"ungmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"gmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"delusers(?: |$)(.*)"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"adminlist"))
@errors_handler
...
@borg.on(sycrox_cmd(pattern=r"pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@borg.on(sycrox_cmd(pattern=r"kick(?: |$)(.*)"))
@errors_handler
async def kick(usr):
...
@borg.on(sycrox_cmd(pattern=r"users ?(.*)"))
@errors_handler
